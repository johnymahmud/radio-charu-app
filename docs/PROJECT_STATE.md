...
- [x] **মাল্টি-পিসি ১-ক্লিক স্মার্ট এমুলেটর ও অ্যাপ রানার:** [run_app.bat](../run_app.bat) তৈরি করা হয়েছে, যা বাসা/অফিসের যেকোনো পিসিতে AVD স্বয়ংক্রিয়ভাবে ডিটেক্ট ও স্টেল লক ক্লিন করে ১-ক্লিকে এমুলেটর বুট ও `flutter run` নিশ্চিত করে।
